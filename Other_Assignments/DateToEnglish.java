...
public class DateToEnglish {
    ...
    static String MonthPrinter(int tempdata){
          ...
          Map month=new HashMap();//for month
        month.put(1,"January");
    ...
    static String YearPrinter(int tempdata){//1994
        
        Map n=new HashMap();
        
        int ones=tempdata%10;//4
        int tens=tempdata/10;//199
        ones=ones+(tens%10)*10;
       
       
        int hundreds=tens/10;
        
            if(hundreds<20)//for years less than 2000
            {
            String part1=DayPrinter(hundreds);//19
            String part2=DayPrinter(ones);//94

            return (part1+"-"+part2);
            }//for years more than 2000
            else{System.out.println("Executing");
                String part1=DayPrinter(hundreds*10);//19
            String part2=DayPrinter(ones);//94
